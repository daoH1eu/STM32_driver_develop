...
#define GPIOE_BASEADDR		(AHB1_BASEADDR + 0x1000u) //Stm32f407 black board has only A to E GPIO
...
/********************************Structure Peripheral Registers definition**************************************/
struct GPIOx_Register{
...
typedef struct GPIOx_Register 	GPIOx_RegDef_t;
typedef struct RCC_Register 	RCC_RegDef_t;
